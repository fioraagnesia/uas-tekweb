     ...
     <div class="table-container">
      ...
      <script>
        $(document).ready(function() {
          // Fungsi loadData utk menampilkan data
          function loadData() {
            $.ajax({
              type: "POST",
              url: "entryNoResi.php",
              ...
              success:function(response) {
                // Kalau sukses, maka akan menampilkan isi tabelnya secara dinamis
          ...
          // Data yg ada ditampilkan dulu di awal
          loadData();
          ...
          $(document).on("click",".btn-delete", function() {
            const row = $(this).closest("tr");    // ambil row yang terdekat dengan tombol delete
            const id = row.data("id");            // simpan idnya
          ...
          $(document).on("click",".btn-entry", function() {
            const row = $(this).closest("tr");        // ambil row yang terdekat dengan buttonnya
            const id = row.data("id");                // simpan idnya
            ...
            if (id) {
              ...
              $.ajax({
                  ...
                  data: { id: id },
                  success: function(response) {
                      window.location.href = 'entryLogPage.php'; // next page
                  }
              });
            }
          });
